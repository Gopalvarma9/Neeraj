...
public class UserController {
	...
	@ResponseBody
	public String saveUserData(@ModelAttribute("BankUser") BankUserInput bankUser,HttpServletRequest request) {
		BankUser b = new BankUser();
		b.setInputModelValues(bankUser);
		bankUserService.saveUser(b);
		HttpSession session = request.getSession();
		String username = (String) session.getAttribute("username");
		applicationEventPublisher.publishEvent(new BankUserDetailsModificationEvent("Bank User Details Modified",username));
